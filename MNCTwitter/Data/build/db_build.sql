...
\copy company from './DB/company.csv' delimiter ',' csv header;
\copy tweet from './DB/tweet.csv' delimiter ',' csv header;
\copy company_tweet from './DB/company_tweet.csv' delimiter ',' csv header;
\copy follower from './DB/follower.csv' delimiter ',' csv header;
\copy favourite from './DB/favourite.csv' delimiter ',' csv header;
\copy comment from './DB/comment.csv' delimiter ',' csv header;
\copy report from './DB/report.csv' delimiter ',' csv header;